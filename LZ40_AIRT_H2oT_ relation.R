...
file1 = import("LZ40_H2OT_Degrees Celsius.csv", colClasses = c("NULL", "character", "numeric"))
file2 = import("LZ40_AIRT_Degrees Celsius.csv", colClasses = c("NULL", "character", "numeric"))
print(file1)
print(file2)
...
# Rename the columns
colnames(merged_data)[colnames(merged_data) == "LZ40_H2OT_Degrees Celsius"] <- "LZ40_H2OT_Degrees_Celsius"
colnames(merged_data)[colnames(merged_data) == "LZ40_AIRT_Degrees Celsius"] <- "LZ40_AIRT_Degrees_Celsius"
# Save merged_data as a CSV file
write.csv(merged_data, "merged_data_LZ40_H20T_AIRT.csv", row.names = FALSE)
...
model <- lm(LZ40_H2OT_Degrees_Celsius ~ LZ40_AIRT_Degrees_Celsius, data = merged_data)
...
#LZ40_H2OT_Degrees_Celsius = 0.388231 + 0.980154 * LZ40_AIRT_Degrees_Celsius
